...
userRoutes.post("/", (request: Request, response: Response, next: NextFunction) =>
  userController.postUser(request, response, next),
);
userRoutes.get("/", (request: Request, response: Response, next: NextFunction) =>
  userController.getUsers(request, response, next),
);
userRoutes.get("/:id", (request: Request, response: Response, next: NextFunction) =>
  userController.getUser(request, response, next),
);
userRoutes.put("/update/:id", (request: Request, response: Response, next: NextFunction) =>
